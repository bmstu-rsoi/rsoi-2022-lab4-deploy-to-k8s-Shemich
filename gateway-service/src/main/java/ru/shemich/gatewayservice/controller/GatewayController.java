...
public class GatewayController {
    ...
    private final String bonusServiceUrl = "http://bonus-service:8050/api/v1";
    private final String flightServiceUrl = "http://flight-service:8060/api/v1";
    private final String ticketServiceUrl = "http://ticket-service:8070/api/v1";
